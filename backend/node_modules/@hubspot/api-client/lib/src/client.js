...
exports.Client = exports.HttpError = exports.siteSearchModels = exports.urlRedirectsModels = exports.schemasModels = exports.performanceModels = exports.hubdbModels = exports.domainsModels = exports.tagsModels = exports.blogPostsModels = exports.authorsModels = exports.auditLogsModels = exports.webhooksModels = exports.oauthModels = exports.timelineModels = exports.ticketsModels = exports.quotesModels = exports.propertiesModels = exports.productsModels = exports.pipelinesModels = exports.objectsModels = exports.ownersModels = exports.lineItemsModels = exports.importsModels = exports.cardsModels = exports.dealsModels = exports.contactsModels = exports.companiesModels = exports.associationsModels = exports.actionsModels = exports.NumberOfRetries = void 0;
...
const api_11 = require("../codegen/crm/associations/api");
...
class Client {
    constructor(options = {}) {
        ...
        this.authentications = {
            hapikey: new api_18.ApiKeyAuth('query', 'hapikey'),
            oauth2: new api_18.OAuth(),
        };
        ...
        this._oauthDefaultApi = new api_26.DefaultApi();
        this._associationsBatchApi = new api_11.BatchApi();
        this._typesApi = new api_11.TypesApi();
        this._companiesAssociationsApi = new api_12.AssociationsApi();
        this._companiesBasicApi = new api_12.BasicApi();
        this._companiesBatchApi = new api_12.BatchApi();
        this._companiesSearchApi = new api_12.SearchApi();
        this._contactsAssociationsApi = new api_13.AssociationsApi();
        this._contactsBasicApi = new api_13.BasicApi();
        this._contactsBatchApi = new api_13.BatchApi();
        this._contactsSearchApi = new api_13.SearchApi();
        this._dealsAssociationsApi = new api_14.AssociationsApi();
        this._dealsBasicApi = new api_14.BasicApi();
        this._dealsBatchApi = new api_14.BatchApi();
        this._dealsSearchApi = new api_14.SearchApi();
        this._cardsApi = new api_15.CardsApi();
        this._cardsSampleResponseApi = new api_15.SampleResponseApi();
        this._importsCoreApi = new coreApi_1.CoreApi();
        this._lineItemsAssociationsApi = new api_16.AssociationsApi();
        this._lineItemsBasicApi = new api_16.BasicApi();
        this._lineItemsBatchApi = new api_16.BatchApi();
        this._lineItemsSearchApi = new api_16.SearchApi();
        this._objectsAssociationsApi = new api_17.AssociationsApi();
        this._objectsBasicApi = new api_17.BasicApi();
        this._objectsBatchApi = new api_17.BatchApi();
        this._objectsSearchApi = new api_17.SearchApi();
        this._ownersDefaultApi = new api_18.DefaultApi();
        this._pipelinesApi = new api_19.PipelinesApi();
        this._pipelineStagesApi = new api_19.PipelineStagesApi();
        this._productsAssociationsApi = new api_20.AssociationsApi();
        this._productsBasicApi = new api_20.BasicApi();
        this._productsBatchApi = new api_20.BatchApi();
        this._productsSearchApi = new api_20.SearchApi();
        this._propertiesBatchApi = new api_21.BatchApi();
        this._propertiesCoreApi = new api_21.CoreApi();
        this._propertiesGroupsApi = new api_21.GroupsApi();
        this._quotesAssociationsApi = new api_22.AssociationsApi();
        this._quotesBasicApi = new api_22.BasicApi();
        this._quotesBatchApi = new api_22.BatchApi();
        this._quotesSearchApi = new api_22.SearchApi();
        this._schemasDefaultApi = new api_23.DefaultApi();
        this._schemasCoreApi = new api_23.CoreApi();
        this._ticketsAssociationsApi = new api_24.AssociationsApi();
        this._ticketsBasicApi = new api_24.BasicApi();
        this._ticketsBatchApi = new api_24.BatchApi();
        this._ticketsSearchApi = new api_24.SearchApi();
        this._eventsApi = new api_25.EventsApi();
        this._templatesApi = new api_25.TemplatesApi();
        this._tokensApi = new api_25.TokensApi();
        this._settingsApi = new api_27.SettingsApi();
        this._subscriptionsApi = new api_27.SubscriptionsApi();
